...
El proxy SMTP SendGrid no está diseñado para utilizarse como servidor de correo electrónico de uso general para recibir correo electrónico entrante o para utilizarse con campañas de marketing por correo electrónico. Si planea importar y enviar correos electrónicos de bienvenida a un gran número de clientes (por ejemplo, 10 000 o más), divida los envíos de importación y correo electrónico durante varios días. Esta práctica ayuda a mantenerse dentro de los límites diarios de envío y protege la reputación de su remitente.
...
Para revisar los registros de actividad para el estado de entrega o una lista de direcciones de correo electrónico rechazadas, bloqueadas o rechazadas, [envíe un ticket de asistencia de Adobe Commerce](https://experienceleague.adobe.com/es/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket). El equipo de soporte técnico **no puede** recuperar los registros de actividad con más de 30 días.
...
Para administrar mejor la configuración de envío de correo electrónico, use su propio [servidor SMTP o proveedor de servicios de envío de correo electrónico](https://experienceleague.adobe.com/es/docs/commerce-admin/systems/communications/email-communications). También puede registrarse en su propio servicio SendGrid para seguir de cerca la pila de Cloud Service.

>[!IMPORTANT]
>
>Si utiliza su propia cuenta de SendGrid, ya no recibirá asistencia de SendGrid a través de Adobe.
>
>Para habilitar su servicio SendGrid propietario o actualizar una clave de API existente, [envíe un vale de soporte de Adobe Commerce](https://experienceleague.adobe.com/es/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket) e incluya la clave de API para su cuenta de SendGrid.
...
>[!WARNING]
>
>Las firmas de DKIM de SendGrid y la compatibilidad con la autenticación de dominios solo están disponibles en los entornos Producción y Ensayo para proyectos Pro. No son compatibles con entornos de inicio.
>
>Debido a esto, es más probable que los correos electrónicos transaccionales enviados desde entornos de inicio se marquen como correo no deseado, ya que no se pueden autenticar completamente.  En entornos Pro, al habilitar DKIM se autentica el dominio de envío, lo que mejora considerablemente la capacidad de envío de correos electrónicos y reduce las posibilidades de que los mensajes se filtren como correo no deseado.
>
>Para mejorar la tasa de entrega de mensajes, actualice de Starter a Pro o utilice su propio servidor SMTP o proveedor de servicios de entrega de correo electrónico. Consulte [Configurar conexiones de correo electrónico](https://experienceleague.adobe.com/es/docs/commerce-admin/systems/communications/email-communications) en la _guía de sistemas de administración_.
...
1. Envíe un [ticket de asistencia](https://experienceleague.adobe.com/es/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket) para solicitar la habilitación de DKIM para un dominio específico (**solo entornos de ensayo y producción Pro**).
...
>[!NOTE]
>
>El archivo `var/log/mail.log` es un *registro en ejecución*. A medida que se agregan nuevas entradas, las entradas más antiguas se eliminan del archivo a lo largo del tiempo. En el registro solo está disponible la actividad de registro más reciente. Las entradas de registro antiguas no se archivan ni se conservan una vez eliminadas de mail.log.
