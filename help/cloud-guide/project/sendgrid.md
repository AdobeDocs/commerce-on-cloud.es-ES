...
>
> Para habilitar su servicio SendGrid propietario o actualizar una clave de API existente, [envíe un vale de soporte de Adobe Commerce](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide#submit-ticket) e incluya la clave de API para su cuenta de SendGrid.
