...
>[!TIP]
>
>A menos que esté usando [Live Search](https://experienceleague.adobe.com/en/docs/commerce/live-search/overview), Adobe recomienda que siempre configure OpenSearch para su proyecto de Adobe Commerce en la nube, incluso si planea configurar una herramienta de búsqueda de terceros para su aplicación de Adobe Commerce. La configuración de OpenSearch proporciona una opción de reserva si falla la herramienta de búsqueda de terceros.
