...
- ![Icono de correcciones](../../assets/fix.svg) **Mejoras de seguridad**: se han aplicado las correcciones de seguridad a las que se hace referencia en la [Actualización de seguridad de Adobe Commerce APSB26-92](https://helpx.adobe.com/security/products/magento/apsb26-92.html).<!--MCLOUD-15035 -->
...
- ![Icono de correcciones](../../assets/fix.svg) **Mejoras de seguridad**: se han aplicado las correcciones de seguridad a las que se hace referencia en la [Actualización de seguridad de Adobe Commerce APSB26-73](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-37421).<!--MCLOUD-15066 -->
