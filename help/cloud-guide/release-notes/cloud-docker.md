...
- ![nuevo icono](../../assets/new.svg) **RabbitMQ**—Se agregó compatibilidad con RabbitMQ 4.3.<!-- MCLOUD-15140 -->

## Versión 1.4.8

Fecha de la versión: 6 de mayo de 2026

- ![nuevo icono](../../assets/new.svg) **Pruebas de servicio actualizadas**—Pruebas actualizadas para MariaDB, RabbitMQ, ActiveMQ, Opensearch y Valkey.<!-- MCLOUD-14821 -->
- ![nuevo icono](../../assets/new.svg) **Valkey**—Se agregó compatibilidad con Valkey 8.1.<!-- MCLOUD-14784 -->
- ![nuevo icono](../../assets/new.svg) **imagen de Opensearch**—Se agregó Opensearch 2.19 y 3.5.<!-- MCLOUD-14790/MCLOUD-14785 -->
- ![nuevo icono](../../assets/new.svg) **ActiveMQ**—Se ha agregado compatibilidad con ActiveMQ 2.51.<!-- MCLOUD-14683 -->
- ![nuevo icono](../../assets/new.svg) **MariaDB**—Se agregó compatibilidad con MariaDB 11.8 y 12.2.<!-- MCLOUD-14635 -->
- ![icono de corrección](../../assets/fix.svg) **MailHog**: se ha corregido la imagen de MailHog.<!-- MCLOUD-14663 -->
...
- ![nuevo icono](../../assets/new.svg) **ActiveMQ**: se ha agregado compatibilidad con ActiveMQ en Cloud Docker con pruebas funcionales.<!-- MCLOUD-13771 -->

## Versión 1.4.4

Fecha de lanzamiento: 7 de agosto de 2025

- ![Icono de corrección](../../assets/fix.svg) **PHP 8.4**—Pruebas de PHP 8.4 añadidas.<!-- MCLOUD-13311 -->
- ![Icono de correcciones](../../assets/fix.svg) **Extensión de FTP** agregó una corrección para la extensión de FTP.<!-- MCLOUD-13843 -->
- ![nuevo icono](../../assets/new.svg) **imagen Opensearch3**—Se ha agregado compatibilidad con Opensearch3.<!-- MCLOUD-13766 -->
- ![nuevo icono](../../assets/new.svg) **pruebas de Opensearch3**—Se agregaron pruebas de PHP 8.4 para Opensearch3.<!-- MCLOUD-13768 -->
- ![nuevo icono](../../assets/new.svg) **Valkey**—Se agregó compatibilidad con Valkey.<!-- MCLOUD-13558 -->
...
- ![nuevo icono](../../assets/new.svg) **Habilitar la caché del Compositor**: ahora puede ampliar la configuración de Docker para habilitar la caché de borrado del Compositor al iniciar el contenedor de Docker. Consulte [Ampliar la configuración de Docker](https://developer.adobe.com/commerce/cloud-tools/docker/configure/) en la guía de _Cloud Docker para Commerce_.
