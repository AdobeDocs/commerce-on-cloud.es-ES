...
description: Aprenda a utilizar la administración de registros de New Relic para agregar, buscar y visualizar datos de registro desde los entornos de ensayo y producción de la nube de Commerce.
