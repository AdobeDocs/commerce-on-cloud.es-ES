...
>[!NOTE]
>
>Algunas extensiones PHP tienen limitaciones de instalación específicas del entorno y no están representadas completamente por la tabla anterior. Por ejemplo, [!DNL LDAP] se puede habilitar en entornos de integración mediante la configuración de proyecto, pero no es una configuración de autoservicio para Ensayo y producción profesionales mediante `.magento.app.yaml`.
