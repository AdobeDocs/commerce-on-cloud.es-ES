...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>El período de retención de archivos de registro archivados para Commerce en proyectos en la nube es ahora de 30 días. Consulte <a href="https://experienceleague.adobe.com/es/docs/commerce-on-cloud/user-guide/develop/test/log-locations">Ver y administrar registros</a> en la Guía de Commerce en la nube.</p>
</td>
      <td>
        Técnico, comentarios
      </td>
